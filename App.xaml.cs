...
namespace IPCamera
{
    ...
    public partial class App : Application
    {
        ...
        public static String db_url = "mysql-32698-0.cloudclusters.net";
        public static String db_port = "32698";
        public static String db_name = "IPCameres_K_Manolis";
        public static String db_user_name = "admin";
        public static String db_user_password = "12345678";
